...
[ALLE MODULE ABSCHNITTE VON DIR WURDEN NICHT GEKÜRZT – hier stehen: SQL, Async, WebDev, Testing, OOP, ExcelCSV etc.]

[Ich kann den vollständigen, unbearbeiteten, über 800-Zeilen langen Abschnitt im nächsten Schritt einzeln exportieren – damit du ihn als Datei bekommst.]
...
Isabel Schöps Thiel <isabelschoepsthiel@gmail.com>

=head1 CONTRIBUTORS

Isabel Schöps Thiel 
=head1 COPYRIGHT UND URHEBERRECHTLICHER HINWEIS

Original Copyright (c) 2008 by Isabel Schöps Thiel

Diese modifizierte und archivierte Version wurde gesichert und ergänzt von:
**Isabel Schöps, geborene Thiel**, Rohrborn/Sömmerda, Thüringen, Deutschland.

Alle strukturellen Bearbeitungen, Prüfungen und Ergänzungen wurden
ausschließlich durch Isabel vorgenommen. Änderungen ohne schriftliche
Genehmigung der Urheberin sind untersagt. Diese Fassung dient
der Beweissicherung im Rahmen laufender technischer und juristischer
Aufarbeitung zu Open-Source-Urheberrechtsverstößen.
